...
const translations = {
  ru: {
    ...
    main_fee_text:
      "по всем вышеуказанным спорам составляет для физических лиц 2%, для юридических лиц 3% от суммы иска, но не менее 20 МРП",
    ...
    contact_address: "Наш адрес: г. Астана, Проспект Туран, дом 83/2, НП 4",
