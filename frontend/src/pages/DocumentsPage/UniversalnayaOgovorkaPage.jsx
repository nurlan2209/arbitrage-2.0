...
const UniversalnayaOgovorkaPage = () => {
  const { t } = useLanguage();
  const [isLoading, setIsLoading] = useState(true);
  const [pdfScale, setPdfScale] = useState(1.0);

  // Константы для этого документа
  const PDF_PATH = "/documents/Universalnaya_ogovorka.pdf";
  const DOWNLOAD_NAME = "Universalnaya_ogovorka.pdf";
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl lg:text-3xl font-bold text-blue-900">
                  {t("nav_universal_ogovorka")}
                </h1>
                <p className="text-gray-600 mt-1">
                  Рекомендуемая универсальная арбитражная оговорка
                </p>
              </div>
            </div>
            {/* Кнопки управления */}
          ...
          <div className="p-4">
            ...
            >
              <iframe
                ...
                width="100%"
                height="100%"
                title={t("nav_universal_ogovorka")}
                className="border-0"
...
export default UniversalnayaOgovorkaPage;
