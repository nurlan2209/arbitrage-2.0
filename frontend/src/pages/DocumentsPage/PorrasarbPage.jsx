...
const PorrasarbPage = () => {
  ...
  const handleDownload = () => {
    ...
    link.href = "/documents/porrasarb.pdf";
    link.download = "Порядок_рассмотрения_арбитражных_дел.pdf";
    link.click();
  };
  ...
  const benefits = [
    {
      icon: Clock,
      title: t("porrasarb_benefit1_title"),
      description: t("porrasarb_benefit1_desc"),
      color: "text-green-600",
      bg: "bg-green-100",
    },
    {
      icon: ShieldCheck,
      title: t("porrasarb_benefit2_title"),
      description: t("porrasarb_benefit2_desc"),
      color: "text-blue-600",
      bg: "bg-blue-100",
    },
    {
      icon: Users,
      title: t("porrasarb_benefit3_title"),
      description: t("porrasarb_benefit3_desc"),
      color: "text-purple-600",
      bg: "bg-purple-100",
    },
    {
      icon: Gavel,
      title: t("porrasarb_benefit4_title"),
      description: t("porrasarb_benefit4_desc"),
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">{t("porrasarb_subtitle")}</p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-lg border border-blue-100 overflow-hidden">
          ...
          <div className="p-4">
            ...
            >
              <iframe
                src="/documents/porrasarb.pdf"
                width="100%"
                height="100%"
                title={t("porrasarb_title")}
                className="border-0"
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  <strong className="text-blue-800">
                    {t("porrasarb_info_purpose_title")}:
                  </strong>
                  <br />
                  {t("porrasarb_info_purpose_desc")}
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <h4 className="font-semibold text-gray-800">
                    {t("porrasarb_section1_title")}
                  </h4>
                </div>
                <p className="text-sm text-gray-600">
                  {t("porrasarb_section1_desc")}
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <h4 className="font-semibold text-gray-800">
                    {t("porrasarb_section2_title")}
                  </h4>
                </div>
                <p className="text-sm text-gray-600">
                  {t("porrasarb_section2_desc")}
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <h4 className="font-semibold text-gray-800">
                    {t("porrasarb_section3_title")}
                  </h4>
                </div>
                <p className="text-sm text-gray-600">
                  {t("porrasarb_section3_desc")}
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <h4 className="font-semibold text-gray-800">
                    {t("porrasarb_section4_title")}
                  </h4>
                </div>
                <p className="text-sm text-gray-600">
                  {t("porrasarb_section4_desc")}
                </p>
              </div>
            </div>
