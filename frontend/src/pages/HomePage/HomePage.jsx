            ...
            <div className="bg-white bg-opacity-95 text-gray-800 p-8 rounded-xl shadow-2xl backdrop-blur-sm border border-white border-opacity-20">
              ...
              <div className="space-y-4">
                <p className="text-lg font-semibold text-blue-900">
                  Коканова Дана Каймашевна
                </p>

                <div className="text-sm text-gray-600 leading-relaxed">
                  <p>
                    <strong>Опыт работы:</strong> секретарь судебного заседания
                    суда г. Астаны (2000–2001), юрист и юристконсульт в ТОО
                    «Актюбинское Управление газового хозяйства» и РГП «Центр по
                    недвижимости МЮ РК по Актюбинской области» (2003–2005),
                    начальник юридического отдела ТОО «Азия Сафари Сервис» г.
                    Алматы (2005–2006), начальник юридического отдела РГКП
                    «Дирекция административных зданий Администрации Президента и
                    Правительства РК» УДП РК г. Астаны (2007–2009), директор
                    РГКП «Дирекция административного здания ВС РК» г. Астана
                    (2009–2011).
                  </p>
                </div>
